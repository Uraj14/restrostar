...
echo "<h5 class='rating' style='text-align:center'>";
echo "<br>Edit Your Review</h5>";
echo "<br><br>";


$sql2 = "SELECT * FROM review WHERE revId='$revId'";
...
if(isset($_SESSION['login_user'])){
  ...
  echo "<h5><pre>   <b> Enter Your New Review <b></pre>  </h5>";
  echo "<form class='form' name='reviewform' method='get' action='edit.php'>";
  echo "<pre>";
  ...
  echo "<input type=hidden name='revRating' value=$revRating></input>";
  echo "<input type=hidden name='revId' value=$revId></input>";
