...
<html lang="en">
  <head>
    ...
    <title>Cuisines-RestroStar</title>
  </head>
  <body>
    <!--Nav Bar Starts Here-->
...
<div class="row">
                  <?php
                    include('db.php');
                    $sql = "SELECT DISTINCT restCuisine FROM restaurant";
                    ...
                    while($row = $result->fetch_assoc())
                    {
                      ...
                      echo "<form action='restrolist.php' method='POST'>";
                      echo "<input type=".'"hidden"',"name=".'"cuisine"'."value=".'"'.$rCuisine.'"'.">";
                      echo "<p></p>";
                      echo "<button class=".'"btn btn-outline-success my-2 my-sm-0"'."type=".'"submit"'."value=".'"Cuisine"'.">";
                      echo $rCuisine;
                      echo "</button>";
                      echo "</form>";
                      echo "</div>";
                  ...
                  <!--
                  <input type="radio" name="cuisine" value="north">North<br>
                  <input type="radio" name="cuisine" value="south"> South<br>
